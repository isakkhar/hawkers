...
class Product(models.Model):
    ...
    url = models.ImageField(upload_to='products/%Y/%M/%D', default='', null=True)
...
class Customer(models.Model):
    user_reference = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True)
    item_totals = models.CharField(max_length=200, null=True, blank=True)
    item_quantities = models.CharField(max_length=200, null=True, blank=True)
    item_indexes = models.CharField(max_length=200, null=True, blank=True)
    item_descriptions = models.CharField(max_length=200, null=True, blank=True)
