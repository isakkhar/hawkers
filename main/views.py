...
from main.models import User, Product, Customer
from django.utils import timezone
from main import default_items, store_formulas
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if ip is not None:
                ...
                try:
                    url = "http://www.travelmath.com/flying-time/from/Paris,+France/to/" + str(
                        id_user.user_country_name)
                    r = requests.get(url)
